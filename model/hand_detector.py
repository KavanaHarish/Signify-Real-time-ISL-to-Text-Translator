...
class HandDetector:
    ...
    def __init__(self, mode=False, max_hands=2, detection_confidence=0.7, tracking_confidence=0.5):
        ...
        self._hands = None  # Lazy init to avoid segfault on startup
    ...
    @property
    def hands(self):
        """Lazy initialization of MediaPipe Hands to avoid segfault on hot reload"""
    ...
    def find_hands(self, img, draw=True):
        ...
        try:
            ...
            # Return original frame on error instead of crashing
            print(f"[HandDetector] find_hands error: {e}")
            return img, type('obj', (object,), {'multi_hand_landmarks': None, 'multi_handedness': None})()
